...
// Memoised: every repoFile call would otherwise re-walk the tree and re-read a
...
Directory repoRoot() {
  final Directory? cached = _cachedRoot;
  if (cached != null) return cached;
  Directory dir = Directory.current.absolute;
  while (true) {
    final pubspec = File('${dir.path}/pubspec.yaml');
    if (pubspec.existsSync() && pubspec.readAsStringSync().contains('name: catchlaw_workspace')) {
